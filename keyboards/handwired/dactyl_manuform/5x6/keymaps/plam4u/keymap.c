    ...
    [_QWERTY] = LAYOUT_5x6(
        ...
        KC_GRV , CTL_Z  , KC_X   , KC_C   , KC_V   , KC_B   ,                       KC_N   , KC_M   , KC_COMM, KC_DOT , CTL_SL  , KC_BSLS,
                          SPACE_L, SPACE_R,                                                           KC_EQL , KC_MINS,
                                            ESC_LW1, SPC_SFT,                       ENT_SFT, BSP_RS1,
                                            OS_LSFT, TD_CMD ,                       OS_RCMD, OS_RSFT,
...
// ============================================================================
// ============================== TD CMD MODS =================================
static td_tap_t cmd_mods_td_state = {
    .state = TD_NONE
};
void dance_cmd_mods_finished(qk_tap_dance_state_t *state, void *user_data) {
    cmd_mods_td_state.state = cur_dance(state);
    switch (cmd_mods_td_state.state) {
        case TD_SINGLE_TAP: register_code(KC_TAB); break;
        case TD_SINGLE_HOLD: register_code(KC_LCMD); break;
        case TD_DOUBLE_HOLD: register_code16(A(KC_LCMD)); break;
        default: break;
    }
}
void dance_cmd_mods_reset(qk_tap_dance_state_t *state, void *user_data) {
    switch (cmd_mods_td_state.state) {
        case TD_SINGLE_TAP: unregister_code(KC_TAB); break;
        case TD_SINGLE_HOLD: unregister_code(KC_LCMD); break;
        case TD_DOUBLE_HOLD: unregister_code16(A(KC_LCMD)); break;
        default: break;
    }
    cmd_mods_td_state.state = TD_NONE;
}
...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_CMD_MODS] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, dance_cmd_mods_finished, dance_cmd_mods_reset),
