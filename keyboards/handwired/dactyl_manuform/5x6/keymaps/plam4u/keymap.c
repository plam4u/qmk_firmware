...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_R_MOUSE] = LAYOUT_5x6(
    ...
    _______, KC_ACL0, KC_ACL0, KC_ACL1, KC_ACL2, _______,        KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_VOLD, _______,
  ...
  [_L_SH_KEYPAD] = LAYOUT_5x6(
    ...
    KC_PDOT, KC_PEQL, KC_7   , KC_8   , KC_9   , KC_KP_0,        _______, _______, _______, _______, _______, _______,
    KC_HOME, KC_PAST, KC_4   , KC_5   , KC_6   , KC_PMNS,        _______, _______, _______, _______, _______, _______,
    _______, KC_PSLS, KC_1   , KC_2   , KC_3   , KC_PPLS,        _______, _______, _______, _______, _______, _______,
                      _______, _______,                                   _______, _______,
                                        _______, _______,        _______, _______,
                                        _______, _______,        _______, _______,
                                        _______, _______,        _______, _______
