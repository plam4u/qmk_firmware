...
enum layer_names {
    ...
    _SYM_LEFT,
    _SYM_NAV,
    _META // activated with both SYM layers
};
enum layer_keycodes {
  QWERTY = SAFE_RANGE,
  COLEMAK,
 ...
 *                                 ┡━━━━━━━╋━━━━━━━┫ ┣━━━━━━━╋━━━━━━━┩
 *                                 │NUM_ESC┃TAB_ALT┃ ┃TAB_ALT┃       │
 *                                 ├───────╄━━━━━━━┩ ┡━━━━━━━╃───────┤
 *                                 │SPACE_L│SPACE_R│ │SPACE_R│SPACE_L│
 *                                 └───────┴───────┘ └───────┴───────┘       generated by [keymapviz] */
    [_QWERTY] = LAYOUT_5x6(
        ALFRED , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   ,                       KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , _______,
        ...
        KC_GRV , CTL_Z  , KC_X   , KC_C   , KC_V   , KC_B   ,                       KC_N   , KC_M   , KC_COMM, KC_DOT , CTL_SL , KC_BSLS,
                          KC_TAB , OS_LALT,                                                           KC_EQL , KC_MINS, 
                                                ...
                                                NUM_ESC, TAB_ALT,              TAB_ALT, _______, 
                                                SPACE_L, SPACE_R,              SPACE_R, SPACE_L
    ),
 ...
 *                                 └───────┴───────┘ └───────┴───────┘       generated by [keymapviz] */
    [_SYM_LEFT] = LAYOUT_5x6(
        ...
        _______, KC_HASH, KC_ASTR, KC_LPRN, KC_RPRN, KC_DLR ,                       _______, _______, _______, _______, _______, _______,
 ...
 *                                 └───────┴───────┘ └───────┴───────┘       generated by [keymapviz] */
    [_NUMPAD] = LAYOUT_5x6(
        ...
        DM_PLY2,_______,_______,_______,_______,KC_PIPE,                            _______, KC_P7 , KC_P8 , KC_P9 ,KC_PPLS,DM_REC2,
        DM_PLY1,_______,_______,_______,_______,KC_AMPR,                            _______, KC_P4 , KC_P5 , KC_P6 ,KC_PEQL,DM_REC1,
 ...
 *                                 └───────┴───────┘ └───────┴───────┘       generated by [keymapviz] */
    [_META] = LAYOUT_5x6(
        KC_F12  ,KC_F1  ,KC_F2  ,KC_F3  ,KC_F4  ,KC_F5  ,                           KC_F6   ,KC_F7  ,KC_F8  ,KC_F9   ,KC_F10 ,KC_F11 ,
        _______ ,KC_AT  ,KC_CIRC,KC_LCBR,KC_RCBR,KC_PIPE,                           CM_LBRC ,KC_MPLY,KC_MUTE,CM_RBRC ,_______,KC_MUTE,
        _______ ,KC_PERC,KC_DLR ,KC_LPRN,KC_RPRN,KC_AMPR,                           KC_LEFT ,KC_DOWN,KC_UP  ,KC_RGHT ,_______,KC_VOLU,
        _______ ,KC_HASH,KC_ASTR,KC_LBRC,KC_RBRC,KC_MINS,                           KC_EQL  ,KC_BSPC,KC_ENT ,KC_DEL  ,_______,KC_VOLD,
                         _______,_______,                                                            _______, _______, 
                                            KC_UNDS, KC_DLR ,                    _______, _______, 
                                            _______, KC_GRV ,                    _______, _______, 
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    switch (keycode) {
        ...
        case SYM_LEFT:
          ...
          update_tri_layer(_SYM_LEFT, _SYM_NAV, _META);
          return false;
          break;
        case SYM_NAV:
          if (record->event.pressed) {
